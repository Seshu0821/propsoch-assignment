        ...
        <div className="container">
            ...
            <div className="diff-toggle">
              ...
              <div className="toggle-buttons">
                <button
                  ...
                  onClick={() => this.setState({ tab: "portal" })}
                >
                  Online Portals
                </button>

                <button
                  className={tab === "broker" ? "active" : ""}
          ...
          {tab === "portal" ? (
            <table className="diff-table">
              <thead>
                <tr>
                  <th className="ss">What you care about</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="highlight">80+ data points</td>
                  <td>20-40 data points</td>
                </tr>
                <tr>
                  <td>Transparency</td>
                  <td className="highlight">Detailed pros & cons</td>
                  <td>Only pros highlighted</td>
                </tr>
                <tr>
                  <td>Data Accuracy</td>
                  <td className="highlight">Verified by architects</td>
                  <td>Loose verification</td>
                </tr>
                <tr>
                  <td>Service Validity</td>
                  <td className="highlight">Till you find your home</td>
                  <td>Based on no. of contacts</td>
                </tr>
                <tr>
                  <td>Data Sources</td>
                  <td className="highlight">RERA, GMaps, CDP etc.</td>
                  <td>Added by developer & broker</td>
                </tr>
              </tbody>
            </table>
          ) : (
            <table className="diff-table">
              <thead>
                <tr>
                  ...
                  <th className="highlight">Propsoch</th>
                  <th>Local brokers</th>
                </tr>
              </thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="highlight">Consultative, no pressure</td>
                  <td>High pressure sales tactics</td>
                </tr>
                <tr>
                  <td>Transparency</td>
                  <td className="highlight">Detailed pros & cons</td>
                ...
                <tr>
                  <td>Project Curation</td>
                  <td className="highlight">Based on 20+ factors</td>
                  <td>Not curated</td>
                </tr>
                <tr>
                  <td>Spam</td>
                  <td className="highlight">No spam</td>
                  <td>High spamming until closure</td>
                </tr>
                <tr>
                  <td>Post sales support</td>
                  <td className="highlight">End-to-end support</td>
                  <td>None</td>
                </tr>
                <tr>
                  <td>Site Visits</td>
                  <td className="highlight">Assisted by experts</td>
                  <td>No market expertise</td>
                </tr>
                <tr>
                  <td>Negotiation</td>
                  <td className="highlight">High leverage via insights</td>
                  <td>No insights to leverage</td>
                </tr>
                <tr>
                  <td>In-Depth Reports</td>
                  <td className="highlight">2 Peace of Mind Reports</td>
                  <td>None</td>
                </tr>
                <tr>
                  <td>Advisor</td>
                  <td className="highlight">Trained architects</td>
                  <td>Local sales people</td>
                </tr>
              </tbody>
            </table>
          )}
